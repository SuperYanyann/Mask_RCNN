# Use Mask R-CNN to clean the background
The old dome used Mask R-CNN <br>
I use the dome to clean the background of a photo <br>
The code sample3_Dome.py and sample3_2_Dome.py can realize the function.
